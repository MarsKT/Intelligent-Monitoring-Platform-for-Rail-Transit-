...
pos_list = load_images('D:/GraduationProject/Project1/Image/INRIAPerson/INRIAPerson/Train/pos.lst')
full_neg_lst = load_images('D:/GraduationProject/Project1/Image/INRIAPerson/INRIAPerson/Train/neg.lst')
sample_neg(full_neg_lst, neg_list, [128, 64])
print(len(neg_list))
computeHOGs(pos_list, gradient_lst)
print('pos has completed')
[labels.append(+1) for _ in range(len(pos_list))]
computeHOGs(neg_list, gradient_lst)
print('neg has completed')
